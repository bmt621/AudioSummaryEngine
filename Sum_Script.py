...
class t5inference:
    def __init__(self,configs,logger):
        ...
        self.src_max_len = configs['data_configs']['max_input_len']
    ...
    def process_data_single(self,text):
        ...
        tokenized_text = self.tokenizer(text,padding='max_length',max_length=self.src_max_len,truncation=True,add_special_tokens=True,return_tensors='pt')
    ...
    def process_data_batch(self,texts,prefix):
        ...
        tokenized_text = [self.tokenizer(translation,padding='max_length',truncation=True,add_special_tokens=True,return_tensors='pt') for translation in texts]
    ...
    def infer_single(self,text,prefix):
        text = prefix + text
        
        output_text = self.process_data_single(text)
